  ...
  <div class="home-page">
    ...
    <div class="home-header">
      <div class="con">
        <h1>U医</h1>
        <div class="search">
          <SvgIcon name="home-search" /> 搜一搜：疾病/症状/医生/健康知识
        </div>
      </div>
    </div>
    ...
    <div class="home-navs">
      <van-row>
        <van-col span="8">
          <router-link to="/consult/doctor" class="nav" @click="consultStore.setConsultTypeAction(ConsultTypeEnum.Doctor)">
        ...
        <van-col span="8">
          <router-link to="/consult/medicine" class="nav" @click="consultStore.setConsultTypeAction(ConsultTypeEnum.Medication)">
